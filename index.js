...
async function registerCommands() {
  ...
  try {
    ...
    console.log(
      "✅ تم تسجيل جميع أوامر البوت بنجاح."
    );
...
client.once(
  ...
  async () => {
    ...
    if (guild) {
      ...
      console.log(
        `⚠️ البوت ليس داخل السيرفر: ${GUILD_ID}`
      );
